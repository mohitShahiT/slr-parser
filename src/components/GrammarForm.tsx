...
export const GrammarForm = function () {
  ...
  return (
    <div className="flex h-screen bg-[#F5EFFF]">
      {/* Left Container */}
      <div className="w-1/2 p-8 flex flex-col items-center">
        ...
        <div className="mb-8 w-full">
          ...
          >
            ...
            <div className="flex justify-center space-x-4">
              <button
                className="bg-gradient-to-r from-[#CDC1FF] to-[#A294F9] hover:from-[#A294F9] hover:to-[#CDC1FF] text-white font-semibold py-2 px-4 rounded transition-colors duration-300"
                type="submit"
              >
                Parse grammar
              </button>
        ...
        <div className="mb-8 w-full">
          ...
          <button
            ...
            className="bg-gradient-to-r from-[#CDC1FF] to-[#A294F9] hover:from-[#A294F9] hover:to-[#CDC1FF] text-white font-semibold py-2 px-4 rounded transition-colors duration-300 w-full"
          >
            View Stack
          </button>
        </div>
      ...
      {/* Right Container */}
      <div className="w-1/2 p-8 flex flex-col bg-[#E5D9F2] rounded-lg m-4 overflow-y-auto">
