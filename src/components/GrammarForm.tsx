...
export const GrammarForm = function(){
    ...
    const handleGrammarChange = function(e:React.ChangeEvent<HTMLTextAreaElement>){
    ...
    <form onSubmit={handleGrammarSubmit}>
      ...
      />
      <button className="border-solid border-2 border-sky-500" type="submit">Enter</button>
      </form>
    </>
}